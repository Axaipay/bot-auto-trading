...
module.exports = class wavesexchange extends Exchange {
    ...
    async getFeesForAsset (symbol,asset1,asset2, side, amount, price, params = {}) {
    ...
    async createOrder (symbol, asset1,asset2, type, side, amount, price = undefined, params = {},decimals1, decimals2, matcherFees) {
        /**
         * @method
        ...
        const amountAsset = asset1;
        const priceAsset = asset2;
        ...
        const byteArray = [
            ...
            this.getAssetBytes (asset1),
            this.getAssetBytes (asset2),
